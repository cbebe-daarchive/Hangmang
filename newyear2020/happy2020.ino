...
void playMelody(int beat[], int tempo)
{
  ...
  int note[58] = {0, 3, 2, 3, 5, 4, 3, 4, 5, 4, 3, 3,
                  5, 6, 7, 7, 6, 5, 5, 3, 4, 3, 4, 5, 4, 3, 1, 1, 0,
                  3, 7, 6, 5, 5, 3, 4, 3, 4, 7, 6, 5, 5, 6, 7, 7,
                  6, 5, 5, 3, 4, 3, 4, 5, 4, 3, 1, 1, 0};
  for (int i = 0; i < 58; i++)
  {
...
{
  int beat[58] = {2, 3, 1, 2, 2, 3, 1, 2, 1, 1, 3, 1,
                  2, 2, 6, 2, 3, 1, 2, 2, 3, 1, 2, 1, 1, 3, 1, 2, 2,
                  6, 2, 3, 1, 2, 2, 3, 1, 2, 2, 3, 1, 2, 2, 6, 2, 3,
                  1, 2, 2, 3, 1, 2, 1, 1, 3, 1, 2, 2};
